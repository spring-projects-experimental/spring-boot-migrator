...
public class SbmWebsocketClient implements SbmClient {
    ...
    public SbmWebsocketClient(StompSessionHandler stompSessionHandler) {
...
//            throw new RuntimeException("Transport error while handling Websocket.", exception);
        ...
        private class ScanResultFrameHandler extends GenericStompFrameHandler<ScanResult>{
            public ScanResultFrameHandler(Consumer<ScanResult> consumer) {
                super(ScanResult.class, consumer);
            }
        }
        private class ScanProgressUpdateHandler extends GenericStompFrameHandler<ScanProgressUpdate> {
            public ScanProgressUpdateHandler(Consumer<ScanProgressUpdate> consumer) {
                super(ScanProgressUpdate.class, consumer);
            }
        }
        private class RecipeExecutionProgressHandler extends GenericStompFrameHandler<RecipeExecutionProgress> {
