...
public class ProgressRendererLogbackLogAdapterTest {
    ...
    void logAdapter() throws InterruptedException, IOException {
        ...
        outContent.flush();
        assertThat(outContent.toString()).endsWith(" [main] INFO org.springframework.sbm.shell2.shell.renderer.ProgressRendererLogbackLogAdapterTest - some info log\n");
        ...
        sut.stop();
        log.warn("info 1");
        assertThat(outContent.toString()).endsWith("[main] WARN org.springframework.sbm.shell2.shell.renderer.ProgressRendererLogbackLogAdapterTest - info 1\n");

        log.info("info 2");
        assertThat(outContent.toString()).contains("[main] INFO org.springframework.sbm.shell2.shell.renderer.ProgressRendererLogbackLogAdapterTest - info 2");
    }
