...
class JMXEndpointExposureReportSectionTest {
    @Test
    @DisplayName("JMX Endpoint Exposure should render")
    void withSingleModuleApplicationShouldRender() {
         ProjectContext context = TestProjectContext
                 ...
                 SpringBootUpgradeReportTestSupport.generatedSection("JMX Endpoint Exposure")
    ...
    @Test
    @DisplayName("JMX Endpoint Exposure should not render")
