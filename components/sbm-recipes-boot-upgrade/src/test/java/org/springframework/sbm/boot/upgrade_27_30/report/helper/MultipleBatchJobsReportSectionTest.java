...
class MultipleBatchJobsReportSectionTest {
    @Test
    @DisplayName("Multiple Batch Jobs should render")
    void withSingleModuleApplicationShouldRender() {
         ProjectContext context = TestProjectContext
                         .buildProjectContext()
                         .withSpringBootParentOf("2.7.5")
                         .withBuildFileHavingDependencies("org.springframework.boot:spring-boot-starter-batch")
                         .build();

                 SpringBootUpgradeReportTestSupport.generatedSection("Multiple Batch Jobs")
    ...
    @Test
    @DisplayName("Multiple Batch Jobs should not render")
