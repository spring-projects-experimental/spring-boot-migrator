...
class SAML2RelyingPartyConfigurationReportSectionTest {
    @Test
    @DisplayName("SAML2 Relying Party Configuration should render")
    void withSingleModuleApplicationShouldRender() {
         ProjectContext context = TestProjectContext
                         .buildProjectContext()
                         .withSpringBootParentOf("2.7.5")
                         .withBuildFileHavingDependencies("org.springframework.security:spring-security-core:6.0.0")
                         .build();

                 SpringBootUpgradeReportTestSupport.generatedSection("SAML2 Relying Party Configuration")
    ...
    @Test
    @DisplayName("SAML2 Relying Party Configuration should not render")
