...
class ServerMaxhttpheadersizeReportSectionTest {
    @Test
    @DisplayName("'server.max-http-header-size' should render")
    void withSingleModuleApplicationShouldRender() {
         ProjectContext context = TestProjectContext
                 ...
                 SpringBootUpgradeReportTestSupport.generatedSection("'server.max-http-header-size'")
    ...
    @Test
    @DisplayName("'server.max-http-header-size' should not render")
