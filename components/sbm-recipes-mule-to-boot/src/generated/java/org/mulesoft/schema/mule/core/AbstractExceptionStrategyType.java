...
/**
 * <p>Java class for abstractExceptionStrategyType complex type.
 * 
...
@XmlType(name = "abstractExceptionStrategyType", propOrder = {
    "commitTransaction",
    "rollbackTransaction",
...
@XmlSeeAlso({
    ServiceExceptionStrategyType.class,
    CustomExceptionStrategyType.class
})
public class AbstractExceptionStrategyType
    extends AbstractNotificationExceptionStrategyType
{

    @XmlElement(name = "commit-transaction")
    protected ExceptionPatternType commitTransaction;
    @XmlElement(name = "rollback-transaction")
     ...
     *     
     */
    public void setCommitTransaction(ExceptionPatternType value) {
     ...
     *     
     */
    public void setRollbackTransaction(ExceptionPatternType value) {
