...
/**
 * <p>Java class for abstractTransactional complex type.
 * 
...
@XmlType(name = "abstractTransactional", propOrder = {
    "messageProcessorOrOutboundEndpoint",
    "abstractExceptionStrategy"
})
public class AbstractTransactional
    extends AbstractMessageProcessorType
{
    ...
    protected JAXBElement<? extends ExceptionStrategyType> abstractExceptionStrategy;
    @XmlAttribute(name = "action")
    protected TransactionalActionType action;
     ...
     *     
     */
    public JAXBElement<? extends ExceptionStrategyType> getAbstractExceptionStrategy() {
        return abstractExceptionStrategy;
    }

    /**
     * Sets the value of the abstractExceptionStrategy property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link CustomExceptionStrategyType }{@code >}
     ...
     *     
     */
    public void setAbstractExceptionStrategy(JAXBElement<? extends ExceptionStrategyType> value) {
        this.abstractExceptionStrategy = value;
    }
     ...
     *     
     */
    public TransactionalActionType getAction() {
        if (action == null) {
            return TransactionalActionType.ALWAYS_BEGIN;
        } else {
            return action;
        }
    }
     ...
     *     
     */
    public void setAction(TransactionalActionType value) {
        this.action = value;
    }
