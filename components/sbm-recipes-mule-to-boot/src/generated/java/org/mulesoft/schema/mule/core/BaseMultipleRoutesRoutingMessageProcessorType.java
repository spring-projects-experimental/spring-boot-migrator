...
/**
 * <p>Java class for baseMultipleRoutesRoutingMessageProcessorType complex type.
 * 
...
@XmlType(name = "baseMultipleRoutesRoutingMessageProcessorType", propOrder = {
    "abstractMessageInfoMapping"
})
@XmlSeeAlso({
    CustomRouter.class
})
public class BaseMultipleRoutesRoutingMessageProcessorType
