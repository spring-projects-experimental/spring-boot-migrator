...
/**
 * <p>Java class for customEncryptionStrategyType complex type.
 * 
...
@XmlType(name = "customEncryptionStrategyType", propOrder = {
    "property"
})
public class CustomEncryptionStrategyType
    extends EncryptionStrategyType
{

    @XmlElement(namespace = "http://www.springframework.org/schema/beans")
    protected List<PropertyType> property;
    @XmlAttribute(name = "strategy-ref", required = true)
