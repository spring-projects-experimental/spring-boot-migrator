...
/**
 * <p>Java class for customSecurityProviderType complex type.
 * 
...
@XmlType(name = "customSecurityProviderType", propOrder = {
    "property"
})
public class CustomSecurityProviderType
    extends SecurityProviderType
{

    @XmlElement(namespace = "http://www.springframework.org/schema/beans")
    protected List<PropertyType> property;
    @XmlAttribute(name = "provider-ref", required = true)
