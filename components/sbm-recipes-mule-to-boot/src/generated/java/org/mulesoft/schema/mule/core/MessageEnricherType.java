...
/**
 * <p>Java class for messageEnricherType complex type.
 * 
...
@XmlType(name = "messageEnricherType", propOrder = {
    "abstractMessageProcessor",
    "abstractOutboundEndpoint",
    "abstractMixedContentMessageProcessor",
    "enrich"
})
public class MessageEnricherType
    extends AbstractMessageProcessorType
{
    ...
    protected List<ExtractEnrichPairType> enrich;
     ...
     * This is why there is not a <CODE>set</CODE> method for the enrich property.
     * 
     * <p>
     ...
     * {@link ExtractEnrichPairType }
     * 
     * 
     */
    public List<ExtractEnrichPairType> getEnrich() {
        if (enrich == null) {
            enrich = new ArrayList<ExtractEnrichPairType>();
        }
        return this.enrich;
    }
