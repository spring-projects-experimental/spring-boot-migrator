...
/**
 * <p>Java class for outboundEndpointWithXaType complex type.
 * 
...
@XmlType(name = "outboundEndpointWithXaType", propOrder = {
...
public class OutboundEndpointWithXaType
    extends AbstractOutboundEndpointType
{
    ...
    @XmlElement(name = "abstract-xa-transaction")
