...
/**
 * <p>Java class for processingStrategyType complex type.
 * 
...
@XmlType(name = "processingStrategyType")
@XmlSeeAlso({
    AsynchronousProcessingStrategy.class,
    CustomProcessingStrategy.class
})
public class ProcessingStrategyType
