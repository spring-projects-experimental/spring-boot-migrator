...
/**
 * <p>Java class for processorWithAtLeastOneTargetType complex type.
 * 
...
@XmlType(name = "processorWithAtLeastOneTargetType", propOrder = {
    "messageProcessorOrOutboundEndpoint"
})
@XmlSeeAlso({
    FirstSuccessful.class
})
public class ProcessorWithAtLeastOneTargetType
