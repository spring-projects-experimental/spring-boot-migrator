    ...
    extends AbstractRoutingMessageProcessorType
{
    ...
    @XmlElement(name = "custom-aggregation-strategy")
    protected AggregationStrategyType customAggregationStrategy;
    @XmlElement(name = "threading-profile")
    protected ThreadingProfileType threadingProfile;
    @XmlElementRefs({
    ...
    /**
     * Gets the value of the customAggregationStrategy property.
     * 
     * @return
     *     possible object is
     *     {@link AggregationStrategyType }
     *     
     */
    public AggregationStrategyType getCustomAggregationStrategy() {
        return customAggregationStrategy;
    }

    /**
     * Sets the value of the customAggregationStrategy property.
     * 
     * @param value
     *     allowed object is
     *     {@link AggregationStrategyType }
     *     
     */
    public void setCustomAggregationStrategy(AggregationStrategyType value) {
        this.customAggregationStrategy = value;
    }
     ...
     *     
     */
    public void setThreadingProfile(ThreadingProfileType value) {
