...
/**
 * <p>Java class for whenMessageProcessorFilterPairType complex type.
 * 
...
@XmlType(name = "whenMessageProcessorFilterPairType", propOrder = {
    "messageProcessorOrOutboundEndpoint"
})
public class WhenMessageProcessorFilterPairType
    extends AbstractMessageProcessorFilterPairType
{
    ...
    protected List<String> evaluator;
     ...
     * 
     */
    public List<String> getEvaluator() {
        if (evaluator == null) {
