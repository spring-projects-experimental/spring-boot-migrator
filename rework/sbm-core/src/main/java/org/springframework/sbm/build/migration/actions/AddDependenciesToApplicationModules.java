...
public class AddDependenciesToApplicationModules implements MultiModuleHandler<AddDependencies> /*AddDependenciesMultiModuleHandler */ {
    private AddDependencies action;
    ...
    @Override
    public void setAction(AddDependencies action) {
        this.action = action;
    }
}
