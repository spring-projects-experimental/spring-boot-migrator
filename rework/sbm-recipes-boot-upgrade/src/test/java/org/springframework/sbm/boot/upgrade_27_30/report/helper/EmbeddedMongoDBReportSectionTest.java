...
class EmbeddedMongoDBReportSectionTest {
    @Test
    @DisplayName("Embedded MongoDB should render")
    void withSingleModuleApplicationShouldRender() {
         ProjectContext context = TestProjectContext
                         .buildProjectContext()
                         .withSpringBootParentOf("2.7.5")
                         .withBuildFileHavingDependencies("org.springframework.data:spring-data-mongodb:3.4.6")
                         .build();

                 SpringBootUpgradeReportTestSupport.generatedSection("Embedded MongoDB")
    ...
    @Test
    @DisplayName("Embedded MongoDB should not render")
