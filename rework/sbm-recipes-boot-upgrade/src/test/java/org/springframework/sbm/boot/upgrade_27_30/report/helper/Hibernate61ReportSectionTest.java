...
class Hibernate61ReportSectionTest {
    @Test
    @DisplayName("Hibernate 6.1 should render")
    void withSingleModuleApplicationShouldRender() {
         ProjectContext context = TestProjectContext
                         .buildProjectContext()
                         .withSpringBootParentOf("2.7.5")
                         .withBuildFileHavingDependencies("org.springframework.data:spring-data-jpa:2.7.6")
                         .build();

                 SpringBootUpgradeReportTestSupport.generatedSection("Hibernate 6.1")
    ...
    @Test
    @DisplayName("Hibernate 6.1 should not render")
