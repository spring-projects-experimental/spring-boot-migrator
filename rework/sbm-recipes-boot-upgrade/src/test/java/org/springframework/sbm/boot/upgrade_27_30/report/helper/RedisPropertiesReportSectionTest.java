...
class RedisPropertiesReportSectionTest {
    @Test
    @DisplayName("Redis Properties should render")
    void withSingleModuleApplicationShouldRender() {
         ProjectContext context = TestProjectContext
                         .buildProjectContext()
                         .withSpringBootParentOf("2.7.5")
                         .withBuildFileHavingDependencies("org.springframework.data:spring-data-redis:2.7.5")
                         .build();

                 SpringBootUpgradeReportTestSupport.generatedSection("Redis Properties")
    ...
    @Test
    @DisplayName("Redis Properties should not render")
