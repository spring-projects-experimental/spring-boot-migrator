...
public class HandlerType {
    ...
    protected org.springframework.sbm.jee.ejb.api.String handlerName;
    ...
    protected List<org.springframework.sbm.jee.ejb.api.String> soapRole;
    @XmlElement(name = "port-name")
    protected List<org.springframework.sbm.jee.ejb.api.String> portName;
     ...
     *     
     */
    public org.springframework.sbm.jee.ejb.api.String getHandlerName() {
        return handlerName;
    }
     ...
     *     
     */
    public void setHandlerName(org.springframework.sbm.jee.ejb.api.String value) {
     ...
     * 
     */
    public List<org.springframework.sbm.jee.ejb.api.String> getSoapRole() {
        if (soapRole == null) {
            soapRole = new ArrayList<org.springframework.sbm.jee.ejb.api.String>();
        }
     ...
     * 
     */
    public List<org.springframework.sbm.jee.ejb.api.String> getPortName() {
        if (portName == null) {
            portName = new ArrayList<org.springframework.sbm.jee.ejb.api.String>();
        }
