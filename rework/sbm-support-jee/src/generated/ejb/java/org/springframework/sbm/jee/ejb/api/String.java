...
@XmlSeeAlso({
    ...
    CmpVersionType.class,
    CmrFieldTypeType.class,
    ConcurrencyManagementTypeType.class,
    ConcurrentLockTypeType.class,
    FullyQualifiedClassType.class,
    MethodIntfType.class,
    MethodNameType.class,
    MultiplicityType.class,
    PersistenceTypeType.class,
    ResultTypeMappingType.class,
    SessionTypeType.class,
    TimeUnitTypeType.class,
    TransAttributeType.class,
