...
class RewriteMavenSettingsInitializerTest {
    ...
    void beforeEach() {
        ...
        baseDir = Path.of("./testcode/maven-projects/project-with-maven-settings/");
        fakedUserHome = baseDir.resolve("user-home").toAbsolutePath().normalize();
    ...
    @Test
    @DisplayName("Test Maven classes to decrypt settings")
    void testMavenClassesToDecryptSettings() throws ComponentLookupException {
...
//        request.setServers()
    ...
    @Test
    void mavenParserMustAdhereToSettingsXmlTest() throws URISyntaxException, ComponentLookupException {
        MavenPlexusContainerFactory containerFactory = new MavenPlexusContainerFactory();
        PlexusContainer plexusContainer = containerFactory.create();
        RewriteExecutionContext executionContext = new RewriteExecutionContext();
        Resource mavenSettingsFile = new DummyResource(Path.of("./testcode/project-with-maven-settings/user-home/settings.xml").toAbsolutePath().normalize(), """
        ...
        RewriteMavenSettingsInitializer sut = new RewriteMavenSettingsInitializer(new MavenPasswordDecrypter(), new MavenPlexusContainerFactory());
