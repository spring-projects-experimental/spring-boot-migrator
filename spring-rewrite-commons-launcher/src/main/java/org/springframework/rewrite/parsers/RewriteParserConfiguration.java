...
import org.springframework.rewrite.boot.autoconfigure.ParserPropertiesPostProcessor;
...
public class RewriteParserConfiguration {
	...
	// FIXME: 945
	// @Bean
	// RewriteMavenProjectParser rewriteMavenProjectParser(MavenPlexusContainer
	// plexusContainer, ParsingEventListener parsingListener, MavenExecutor mavenExecutor,
	// MavenMojoProjectParserFactory projectParserFactory, ScanScope scanScope,
	...
	RewriteProjectParser rewriteProjectParser(ProvenanceMarkerFactory provenanceMarkerFactory,
			...
			ParserProperties parserProperties, ParsingEventListener parsingEventListener,
		...
		return new RewriteProjectParser(provenanceMarkerFactory, buildFileParser, sourceFileParser, styleDetector,
				parserProperties, parsingEventListener, eventPublisher, scanScope, beanFactory, projectScanner,
